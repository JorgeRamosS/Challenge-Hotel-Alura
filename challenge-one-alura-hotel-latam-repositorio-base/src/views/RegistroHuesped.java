	 ...
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    private void guardarHuesped() {
	    	if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
	    		...
	    		int nrserva = Integer.parseInt(txtNreserva.getText());
	    		Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaNacimiento), txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), nrserva);
